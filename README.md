...
The project scope was to create a command-line application that dynamically generates a professional README.md file from a user's input using the [Inquirer package](https://www.npmjs.com/package/inquirer). By quickly and easily creating a README file by using a command line application to generate one, the project creator has more time to devote to working on their project.
